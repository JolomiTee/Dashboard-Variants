        ...
        <>
            <form onSubmit={(e) => e.preventDefault()} className="flex flex-col gap-3 sm:w-full sm:mt-[10px] mdl:flex-row mdl:items-end mdl:mb-5 xl:mb-0 lg:flex-col lg:items-center xl:max-w-[430px] xl:grid">
                ...
                <div className="flex flex-col gap-2 md:min-w-[200px] lg:w-full">
                    <span className='dark:text-white'>You Sell</span>
                    ...
                    <div className='p-1 lg:p-2 bg-[#F6F6F6] border border-blok-color rounded-8 flex gap-2 justify-between items-center text-14 font-cabinet font-bold relative'>
                        ...
                        <div className="">
                            <input
                                ...
                                name="amount_paid"
                                id="amount_paid"
                                className='h-10 px-3 text-end text-16 rounded-8 focus:ring-0 focus:outline-transparent focus:border-transparent border-1 w-[100%] placeholder:text-14' placeholder='Enter an Amount' onChange={handlePayableAmountChange}
                                 />
                        </div>
                ...
                <div className="flex flex-col gap-2 md:min-w-[200px] lg:w-full pb-8">
                    ...
                    <div className='p-1 lg:p-2 bg-[#F6F6F6] border border-blok-color rounded-8 flex gap-2 justify-between items-center text-14 font-cabinet font-bold'>
                        ...
                        <div className="">
                            ...
                            <input type="number" name="amount_paid" id="amount_paid" className='h-10 px-3 text-end text-16 rounded-8 focus:ring-0 focus:outline-transparent focus:border-transparent border-1 w-[100%] placeholder:text-14 lg:placeholder:text-16' value={(payableAmount * selectedRecievableCoinRate)} readOnly />
                        </div>
                ...
                <div className="flex-grow lg:w-full">
                    ...
                    >
                        Sell {selectedRecievableCoin.name || 'Coin'}
                    </button>
                </div>
            </form>
        </>
